...
<div style="color: white; font-size:20px;">
    ...
    <div style="margin-top:180px; margin-left: 100px">
        ...
        <a style="margin-top:20px; color:#DDCCAA;" href="{{config(app('saxeli'))}}/reset-password/{{$passwordReset->token}}/{{$passwordReset->email}}/">http://localhost:3000/reset-password/{{$passwordReset->token}}/{{$passwordReset->email}}/</a>
