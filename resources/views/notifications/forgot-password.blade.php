...
<div style="color: white; font-size:20px;">
    ...
    <div style="margin-top:180px; margin-left: 100px">
        ...
        <a href="{{config('app.front_url')}}/reset-password/{{$passwordReset->token}}/{{$passwordReset->email}}/" style="text-decoration:none; color:white; padding: 10px 20px; background-color: #E31221;">Password Reset</a>
        <p style="margin-top:60px; margin-bottom:50px">If clicking doesn't work, you can try copying and pasting it to your browser:</p>
        <a style="margin-top:20px; color:#DDCCAA;" href="{{config('app.front_url')}}/reset-password/{{$passwordReset->token}}/{{$passwordReset->email}}/">{{config('app.front_url')}}/reset-password/{{$passwordReset->token}}/{{$passwordReset->email}}/</a>
